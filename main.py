...
Function that takes airline data as input and create 5 dataframes based on the grouping condition to be used for 
...
def get_graph(chart, year, children1, children2, c3, c4, c5):
    ...
    if chart == 'OPT1':
        ...
        # Average flight time by reporting airlinefrom dash import html
